            ...
            <div class="card-body">
                <div class="row">
                    <div class="col col-sm-12 col-lg-4">
                        <img src="<?php echo e(asset("images/$product->photo")); ?>"
                             class="img-thumbnail" alt="<?php echo e($product->name); ?>" width="100%">
                    </div>
                    <div class="col col-sm-12 col-lg-8 mt-3">
                        <div class="row mb-2">
                            ...
                            <div class="col col-2">
                                <a href="<?php echo e(route('products.delete', $product->id)); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\test\WebSec230104326\resources\views/products/index.blade.php ENDPATH**/ ?>